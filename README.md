...
Can be used even for users without Python installed (can be compiled into an executable)
...
- `zlib` (standard Python module. Only if you're running `csochef.py`)
- Works on Windows, Linux, and MacOS
...
1. Go to the [Releases](https://github.com/yourusername/csochef/releases) page.  
...
3. Start compressing/decompressing!
```bash
